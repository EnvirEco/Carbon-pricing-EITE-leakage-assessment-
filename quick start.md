...
•	Output: did_panel_final_clean_2007-2023.csv
...
Execute the DiD model. This script performs multiple specifications and applies Wild Cluster Bootstrapping to account for the small number of provincial clusters (n=10).
